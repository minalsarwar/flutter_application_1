      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 14),
            Text('Loading...', style: const TextStyle(color: Colors.black)),
          ],
        ),
      );
    }
    return Scaffold(
      ...
      body: Material(
        ...
        child: GridView.builder(
          ...
          itemCount: postModel.post?.length,
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () {
                showProductDetails(context, postModel.post![index]);
              },
              child: Card(
                color: Colors.white,
                child: GridTile(
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Image.network(
                          postModel.post![index].imageLink ?? '',
                          width: 80,
                          height: 80,
                        ),
                      ),
